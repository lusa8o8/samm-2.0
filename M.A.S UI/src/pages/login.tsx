          ...
          <div className="flex items-center justify-center bg-[#fcfbf8] px-6 py-8 sm:px-10 lg:px-12 lg:py-10">
            <div className="w-full max-w-sm">
              ...
              <div className="mt-6 text-center lg:mt-0 lg:text-left">
                ...
                <h2 className="mt-4 text-[2.1rem] font-semibold tracking-tight text-[#0b0b0c]">sign in to the workspace</h2>
                <p className="mt-3 text-sm leading-6 text-muted-foreground">
                  Access is currently onboarding-only while samm is still in PMF. Sign in if your workspace has already
                  been activated, or join the waitlist for manual onboarding.
                </p>
              </div>
              ...
              <div className="mt-5 rounded-[1.2rem] border border-black/8 bg-white/80 px-4 py-4 text-sm text-muted-foreground shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
