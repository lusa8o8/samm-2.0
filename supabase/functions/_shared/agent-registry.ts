...
export const AGENT_REGISTRY = {
  ...
  plan_agent: {
    ...
    required_inputs: ['platform_metrics', 'academic_calendar', 'content_feed', 'posting_limits'],
  ...
  campaign_planner: {
    ...
    required_inputs: ['calendar_event', 'performance_summary', 'competitor_insights', 'ambassador_summary'],
